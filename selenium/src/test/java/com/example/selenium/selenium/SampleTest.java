...
public class SampleTest {
	...
	public void タイトルチェック() throws IOException {
		...
		FileUtils.moveFile(tempFile01, new File("/var/lib/jenkins/workspace/SampleTest/01_titleCheck.png"));
	...
	public void 名前だけを入力して次へを押すとエラー画面に遷移すること() throws IOException {
		...
		FileUtils.moveFile(tempFile02, new File("/var/lib/jenkins/workspace/SampleTest/02_onlyName.png"));
		...
		FileUtils.moveFile(tempFile03, new File("/var/lib/jenkins/workspace/SampleTest/03_error.png"));
