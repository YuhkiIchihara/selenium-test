...
public class SampleTest {
	...
	public void タイトルチェック() throws IOException {
		...
		FileUtils.moveFile(tempFile01, new File("/usr/local/tomcat/temp/01.png"));
	...
	public void 名前だけを入力して次へを押すとエラー画面に遷移すること() throws IOException {
		...
		FileUtils.moveFile(tempFile02, new File("/usr/local/tomcat/temp/02.png"));
		...
		FileUtils.moveFile(tempFile03, new File("/usr/local/tomcat/temp/03.png"));
